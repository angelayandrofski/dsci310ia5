...
The goal of dsci310ia5 is to create a toy package for a homework assignment

## Installation

You can install the development version of dsci310ia5 from [GitHub](https://github.com/) with:
